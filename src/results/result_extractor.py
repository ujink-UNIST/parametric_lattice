...
# from results.energy_extractor import (
#     compute_energy_density_stats,
# )
# from results.force_extractor import extract_face_forces
# from results.stress import (
#     average_force,
#     check_force_balance,
...
#         raw = (
#             getattr(post, "frequency_values", None)
#             if post is not None
#             else None
#         )
...
#         if raw is not None:
#             freqs = _normalize_frequency_values(
...
#     physical = (
#         freqs[rigid_body_mode_count:]
#         if len(freqs) > rigid_body_mode_count
#         else tuple()
#     )
#     return {
#         f"freq_{idx}": freq
#         for idx, freq in enumerate(physical, start=1)
#     }
...
#         return stiffness, {}
#     relative = {
#         k: (v / e_mod) for k, v in stiffness.items()
#     }
...
#         effective_density = (
#             float(material_density) * relative_density
#         )
#         return (effective_density, relative_density)
#     except Exception:
#         return _fallback_from_geometry()
...
#     factor = (
#         length_scale
#         * math.sqrt(material_density / elastic_modulus)
#         / math.sqrt(relative_density)
#     )
#     rel: Dict[str, float] = {}
#     for key, freq_hz in sorted(
#         modal_frequencies.items(), key=_mode_index
#     ):
#         omega = (
...
#             modal_frequencies = _extract_modal_frequencies(
#                 mapdl
#             )
#             relative_modal_frequencies = (
#                 _compute_relative_modal_frequencies(
#                     modal_frequencies,
#                     length_scale=_characteristic_length(
#                         unit_cell
#                     ),
...
#             print(
#                 f"[result_extractor] element energy density stats skipped: {exc}"
#             )

#         face_forces = extract_face_forces(
#             mapdl, sim_case.model, unit_cell
#         )

#         face_tractions = {}
#         for pos_face in POSITIVE_FACES:
#             neg_face = OPPOSITE_FACE[pos_face]
#             avg_force = average_force(
#                 face_forces[neg_face], face_forces[pos_face]
#             )
#             area = face_area(unit_cell.size, pos_face)
#             face_tractions[pos_face] = compute_traction(
#                 avg_force, area
#             )

#         stress = compute_stress_tensor(face_tractions)
#         stiffness, relative_stiffness = (
#             _compute_stiffness_terms(
#                 stress,
...
#     except Exception as exc:
#         print(
#             f"[result_extractor] Extraction failed: {exc}"
#         )
#         return SimResult(
#             sim_case=sim_case,
#             stress=StressTensor9(),
